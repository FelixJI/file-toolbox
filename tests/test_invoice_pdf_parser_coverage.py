"""pdf_parser 辅助函数的单元测试(纯函数,不依赖 pdfplumber)。

覆盖未达行:
- _learn_columns: fallback 补列(行 152)
- _extract_detail_items: 空输入(193)、无表头(205)、空 name 跳过(236)、续行合并(243-251)
- _extract_invoice_number: fallback 18+ 位(282-287)
- _extract_issue_date: 中文日期(297)
- _find_label_word / _extract_party_by_label: 购/销标签(332, 362, 369-372)
- _extract_tax_ids: 各分支(397, 402-405)
- _extract_amounts: 小写兜底(451-456)
- _find_amount_in_next_rows: ValueError / 向前看(469-470, 477-482)
- _extract_amount_chinese: 无匹配(494)
"""
